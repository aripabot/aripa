...
import { resolveDuration, resolveUserReference } from "@/commands/command-resolvers.ts";
import { getGuildConfigStore, type GuildConfigStore } from "@/config/guild-config-store.ts";
import { getActiveMuteStore, type ActiveMuteStore } from "@/moderation/active-mute-store.ts";
import { getMuteScheduler, type MuteScheduler } from "@/moderation/mute-scheduler.ts";
import {
  botCanManageRole,
