...
import {
  ...
  selectedModelIndex,
} from "@/onboarding-wizard/model-options.ts";
import {
  formatRateLimitInputValue,
  previousStepFor,
  rateLimitPresetIndex,
  stepIndex,
} from "@/onboarding-wizard/navigation.ts";
import { loadStylePrompts, stylePromptDescription } from "@/onboarding-wizard/style-prompts.ts";
  ...
  switch (step) {
    ...
    case "style":
      return [
        ...
        Text({
          content: "This selects a Markdown file from src/agent/prompts/styles.",
          fg: colors.muted,
        }),
        selectControl(
